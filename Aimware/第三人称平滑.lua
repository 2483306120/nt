...
local tab = gui.Tab(rb_ref, "thirdperson", "🌟第三人称平滑动画")
local gb_r = gui.Groupbox(tab, "🌟第三人称平滑动画", 15, 15, 250, 400)
local thirdperson_slider = gui.Slider(gb_r, "thirdperson_slider", "距离", 150, 0, 500)
